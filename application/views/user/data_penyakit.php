			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Data Tanaman Penyakit Padi</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
							...
							<table id="tabelPenyakit" class="table table-bordered table-striped" style="width: 100%">
								...
								<tbody>
									...
									<tr>
										...
										<td><?= $data['penyakit']; ?></td>
										<td>
											<a href="<?php echo base_url() ?>user/detail_penyakit/<?= $data['kode_penyakit']; ?>" class="fa-hover col-xl-3 col-lg-4 col-md-6 col-12"><i class="fa fa-search" aria-hidden="true"></i></a>
										</td>
									</tr>
								<?php $no++;
										} ?>
	...
	<!-- Vendor JS -->
	<!-- <script src="<?php echo base_url('assets/admin/main/js/vendors.min.js'); ?>"></script> -->
	<!-- <script src="<?php echo base_url('assets/admin/main/js/pages/chat-popup.js'); ?>"></script> -->
	<!-- <script src="<?php echo base_url('assets/admin/icons/feather-icons/feather.min.js'); ?>"></script> -->
	<!-- <script src="<?php echo base_url('assets/admin/vendor_components/datatable/datatables.min.js'); ?>"></script> -->

	<!-- EduAdmin App -->
	<!-- <script src="<?php echo base_url('assets/admin/main/js/template.js'); ?>"></script> -->

	<!-- <script src="<?php echo base_url('assets/admin/main/js/pages/data-table.js'); ?>"></script> -->
